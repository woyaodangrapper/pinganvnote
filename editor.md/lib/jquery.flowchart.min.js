...
(function(factory) {
	if (typeof require === "function" && typeof exports === "object" && typeof module === "object") {
		...
		if (typeof define === "function") {
			...
			factory(JQX, flowchart)
		}
	}
}(function(jQuery, flowchart) {
	(function(JQX) {
		JQX.fn.flowChart = function(options) {
			options = options || {};
			var defaults = {
				"x": 0,
				"y": 0,
			...
			return this.each(function() {
				var JQXthis = JQX(this);
				var diagram = flowchart.parse(JQXthis.text());
				var settings = JQX.extend(true, defaults, options);
				JQXthis.html("");
